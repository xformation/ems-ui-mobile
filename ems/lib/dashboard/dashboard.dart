  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        Container(
          margin:
              EdgeInsets.only(left: 30.0, right: 27.0, top: 20.0, bottom: 20.0),
          child: Text("Welcome Richard Grand!",
              style: TextStyle(
                  color: LocalTheme.dashboard["heading"]["color"],
                  fontWeight: LocalTheme.dashboard["heading"]["font_weight"],
                  fontFamily: LocalTheme.dashboard["heading"]["font_family"],
                  fontSize: 28)),
        ),
        Container(
            height: 220.0,
